// â”€â”€â”€ SERVIDOR API ECUAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// GET /api/noticias
// Params: ciudad, categoria, q (bÃºsqueda), limit, offset
...
// GET /api/ciudades â€” lista de ciudades con conteo de noticias
...
// GET /api/fuentes â€” estado de las fuentes
...
// POST /api/fetch â€” trigger manual de fetch (Ãºtil para admin)
app.post('/api/fetch', async (req, res) => {
  ...
  console.log('ðŸ”„ Fetch manual triggered via API');
...
// â”€â”€â”€ CRON JOB â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Correr el fetcher cada N minutos (configurable en .env)
const cronExpr = `*/${INTERVAL} * * * *`;
console.log(`â° Cron configurado: cada ${INTERVAL} minutos (${cronExpr})`);

cron.schedule(cronExpr, () => {
  console.log(`\nâ° Cron trigger â€” ${new Date().toLocaleString('es-EC')}`);
  fetchAll().catch(err => console.error('Cron error:', err));
});

// â”€â”€â”€ ARRANCAR SERVIDOR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
app.listen(PORT, async () => {
  console.log(`\nðŸš€ ECUAL API corriendo en http://localhost:${PORT}`);
